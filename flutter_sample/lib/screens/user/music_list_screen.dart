...
class MusicListScreen extends StatefulWidget {
  ...
  const MusicListScreen({super.key, this.categoryId, this.categoryName});
...
class _MusicListScreenState extends State<MusicListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final categoryTitle = widget.categoryName?.trim().isNotEmpty == true
          ...
          Expanded(
            child: StreamBuilder<List<Music>>(
              ...
              builder: (context, musicSnapshot) {
                ...
                final allItems = _filter(musicSnapshot.data!);
                var items = allItems;
