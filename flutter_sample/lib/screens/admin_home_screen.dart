                ...
                return Column(
                  children: [
                    _AdminActionCards(
                      ...
                      onManageAlbums: () => controller.index = 2,
                    ),
                    Expanded(
                      child: TabBarView(
                        children: [
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () {
                ...
                if (tabIndex == 1) {
                  ...
                  Navigator.pushNamed(context, AlbumFormScreen.routeName);
                } else {
...
class _AdminActionCards extends StatelessWidget {
  ...
  final VoidCallback onManageAlbums;

  const _AdminActionCards({
    required this.onAddMusic,
    required this.onManageCategories,
    required this.onManageAlbums,
  });
...
class _AdminAlbumsTab extends StatelessWidget {
  const _AdminAlbumsTab();
            ...
            return ListTile(
              ...
              subtitle: Text(
                album.artist.isEmpty
                    ? album.description
                    : '${album.artist} • ${album.description}',
              ),
              onTap: () => Navigator.pushNamed(
                context,
                AlbumFormScreen.routeName,
                arguments: album,
              ),
              trailing: IconButton(
                icon: const Icon(Icons.delete_outline),
                onPressed: () async {
                  final confirmed = await showDialog<bool>(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: const Text('This will remove the album.'),
                      actions: [
                        TextButton(
                          onPressed: () => Navigator.pop(context, false),
                          child: const Text('Cancel'),
